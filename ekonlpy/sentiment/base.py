...
class BaseDict(object):
    ...
    :param kind: An parameter to select a lexicon file for MPKO subclass.
        ...
        0: a lexicon file generated by polarity induction and seed propagation method with 4-gram tokens.

        1: a lexicon file generated by pmi method based on the probability of 7-gram tokens and change of call rates.
    '''
